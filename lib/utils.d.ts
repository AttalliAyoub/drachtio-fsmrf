...
export declare const sortFunctor: (codecs: string[], rtp: any[]) => (a: string | number, b: string | number) => number;
export declare const modifySdpCodecOrder: (sdp: string, codecList: string[]) => string;
export declare const pick: <T extends Record<string, any>>(obj: T, keys: string) => Partial<T>;
